...
import mist.nexus.com.nexus.Comentarios.DBZComentarios;
import mist.nexus.com.nexus.Constants;
import mist.nexus.com.nexus.R;

public class TelaDBZ extends YouTubeBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dbz_tela);
        ...
        onInitializedListener = new YouTubePlayer.OnInitializedListener() {
            ...
            public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean button) {
                ...
                youTubePlayer.loadVideo(Constants.urlVideoDBZ);
                youTubePlayer.play();
    ...
    public void chamarComentario(View view){
        ...
        startActivity(new Intent(this, DBZComentarios.class));
    }
