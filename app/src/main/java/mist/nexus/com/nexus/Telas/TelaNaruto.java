...
import mist.nexus.com.nexus.Comentarios.NarutoComentarios;
import mist.nexus.com.nexus.Constants;
import mist.nexus.com.nexus.R;

public class TelaNaruto extends YouTubeBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.naruto_tela);
        ...
        onInitializedListener = new YouTubePlayer.OnInitializedListener() {
            ...
            public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean button) {
                ...
                youTubePlayer.loadVideo(Constants.urlVideoNaruto);
                youTubePlayer.play();
    ...
    public void chamarComentario(View view){
        ...
        startActivity(new Intent(this, NarutoComentarios.class));
    }
