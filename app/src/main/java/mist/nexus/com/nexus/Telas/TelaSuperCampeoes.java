...
import mist.nexus.com.nexus.Comentarios.CampeoesComentarios;
import mist.nexus.com.nexus.Constants;
import mist.nexus.com.nexus.R;

public class TelaSuperCampeoes extends YouTubeBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.supercampeoes_tela);
        ...
        onInitializedListener = new YouTubePlayer.OnInitializedListener() {
            ...
            public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean button) {
                ...
                youTubePlayer.loadVideo(Constants.urlVideoSuperCampeoes);
                youTubePlayer.play();
    ...
    public void chamarComentario(View view){
        ...
        startActivity(new Intent(this, CampeoesComentarios.class));
    }
