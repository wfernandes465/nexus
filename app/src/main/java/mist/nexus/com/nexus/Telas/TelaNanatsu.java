...
import mist.nexus.com.nexus.Comentarios.NanatsuComentarios;
import mist.nexus.com.nexus.Constants;
import mist.nexus.com.nexus.R;

public class TelaNanatsu extends YouTubeBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nanatsu_tela);
        ...
        onInitializedListener = new YouTubePlayer.OnInitializedListener() {
            ...
            public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean button) {
                ...
                youTubePlayer.loadVideo(Constants.urlVideoNanatsu);
                youTubePlayer.play();
    ...
    public void chamarComentario(View view){
        ...
        startActivity(new Intent(this, NanatsuComentarios.class));
    }
